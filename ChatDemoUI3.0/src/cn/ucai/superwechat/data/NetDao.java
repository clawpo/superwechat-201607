...
public class NetDao {
    ...
    public static void getAllGift(Context context, OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
    ...
    public static void getBalance(Context context, String username, OkHttpUtils.OnCompleteListener<String> listener){
        ...
        utils.setRequestUrl(I.REQUEST_BALANCE)
                .addParam(I.Live.uname,username)
                .targetClass(String.class)
                .execute(listener);
    }
    ...
    public static void givingGift(Context context, String username, String anchor,int giftId,
        ...
        utils.setRequestUrl(I.REQUEST_GIVING_GIFT)
                .addParam(I.Live.uname,username)
                .addParam(I.Live.anchor,anchor)
                .addParam(I.Live.giftId,String.valueOf(giftId))
                .addParam(I.Live.giftNum,"1")
                .targetClass(String.class)
                .execute(listener);
    }
}
