...
import cn.ucai.superwechat.domain.LiveSettings;
...
//        usernameView.setText(anchorId);
        EaseUserUtils.setCurentAppUserAvatar(this,mIvUseravatar);
...
//    liveRoom = (LiveRoom) intent.getSerializableExtra("liveroom");
//    L.e(TAG,"liveroom="+liveRoom);
//
//    if(liveRoom==null)finish();
//    liveId = liveRoom.getId();
//    chatroomId = liveRoom.getChatroomId();
//  }
...
//  }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mSettings != null && mSettings.isOpenLogRecoder()) {
